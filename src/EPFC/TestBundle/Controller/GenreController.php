...
class GenreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $genres = $em->getRepository('TestBundle:Genre')->findAll();
    ...
    {
        $genre = new Genre();
        $form = $this->createForm('EPFC\TestBundle\Form\GenreType', $genre);
    ...
    {
        $deleteForm = $this->createDeleteForm($genre);
        $editForm = $this->createForm('EPFC\TestBundle\Form\GenreType', $genre);
